...
uv tool install --managed-python -p ">=3.13,<3.15" --no-build --upgrade "%PACKAGE_NAME%%PACKAGE_VERSION%"
if errorlevel 1 (
...
uvx --managed-python -p ">=3.13,<3.15" --no-build %PACKAGE_NAME% %COMMANDLINE_ARGS%
pause
